...
var compose = function compose() {
  ...
  return function (p) {
    var result = args.reduce(function (acc, arg) {
      return _objectSpread({}, acc, {}, arg(p));
    }, {});
    return result;
  };
};
...
var base = function base(css) {
  return function (props) {
    var properties = _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_5___default()(css).reduce(function (obj, key) {
      var property = getProperty(_objectSpread({}, props, {}, css), key);
      return _objectSpread({}, obj, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])({}, key, property));
    }, {});
...
//# sourceMappingURL=index.js.688301dc134e12343060.hot-update.js.map